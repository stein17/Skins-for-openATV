...
# ------------------------------------------------------------
# Copy file to:
# /usr/lib/enigma2/python/Components/Converter/BLEventTime.py
#
# Restart Enigma2:
# find /usr/lib/enigma2/python/Components/Converter/ -name 'BLEventTime*.pyc' -delete && init 4 && sleep 3 && init 3
#
...
class BLEventTime(Converter, Poll):
    STARTTIME = 0
    ENDTIME = 1
    TIMES = 2
