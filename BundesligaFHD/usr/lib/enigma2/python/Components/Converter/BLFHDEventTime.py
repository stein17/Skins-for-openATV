...
# ------------------------------------------------------------
# Copy file to:
# /usr/lib/enigma2/python/Components/Converter/BLFHDEventTime.py
#
# Restart Enigma2:
# find /usr/lib/enigma2/python/Components/Converter/ -name 'BLFHDEventTime*.pyc' -delete && init 4 && sleep 3 && init 3
#
...
class BLFHDEventTime(Converter, Poll):
    STARTTIME = 0
    ENDTIME = 1
    TIMES = 2
