# -*- coding: utf-8 -*-
"""OAWeather-Rückfallintegration für BundesligaFHD."""
from __future__ import absolute_import

from xml.etree.ElementTree import fromstring, tostring


RENDERER_NAME = "BLFHDAnimatedWeatherPixmap"
PATCH_MARKER = "_bundesligafhd_weather_skin_loader"
SKIN_CALLBACK_MARKER = "_bundesligafhd_weather_registry_callback"
...
def patch_oaweather_skin_loader(weatherhelper):
    ...
    def load_skin(skinName=""):
        ...
        if count:
            print(
                "[BundesligaFHD] OAWeather-Screen %s: %d Wetterwidgets aktiviert."
...
def install_oaweather_integration():
    ...
    if loader_patched:
        print("[BundesligaFHD] OAWeather-Wetteranimation ist aktiv.")
