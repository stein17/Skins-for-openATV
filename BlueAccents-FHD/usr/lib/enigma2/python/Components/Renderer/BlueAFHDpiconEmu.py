...
class BlueAFHDpiconEmu(Renderer, Poll):
	__module__ = __name__
	searchPaths = ('/usr/share/enigma2/%s/', '/usr/share/enigma2/BlueAccents-FHD/%s/', '/media/sde1/%s/', '/media/cf/%s/', '/media/sdd1/%s/', '/media/hdd/%s/', '/media/usb/%s/', '/media/ba/%s/', '/mnt/ba/%s/', '/media/sda/%s/', '/etc/%s/')
