...
#Channel Selection Backdrop
	#<widget source="ServiceEvent" render="PliModBackdropX" nexts="0" position="750,500"  usedImage="backdrop" cornerRadius="6" size="170,96" zPosition="98" />
...
from Components.Renderer.PliModBackdropXDownloadThread import PliModBackdropXDownloadThread
...
class BackdropDB(PliModBackdropXDownloadThread):
    def __init__(self):
        PliModBackdropXDownloadThread.__init__(self)
        self.logdbg = None
...
class BackdropAutoDB(PliModBackdropXDownloadThread):
    def __init__(self):
        PliModBackdropXDownloadThread.__init__(self)
        self.logdbg = None
...
class PliModBackdropX(Renderer):
    def __init__(self):
    ...
    def logBackdrop(self, logmsg):
        if self.logdbg:
            w = open(path_folder + "PliModBackdropX.log", "a+")
            w.write("%s\n"%logmsg)
            w.close()
