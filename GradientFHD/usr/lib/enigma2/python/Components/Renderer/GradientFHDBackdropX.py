#!/usr/bin/python3
# -*- coding: utf-8 -*-
# GradientFHDBackdropX.py - patched build (progress + live bouquets + stream filter)
...
# <widget source="session.Event_Now" render="GradientFHDBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Next" render="GradientFHDBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Now" render="GradientFHDBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="session.CurrentService" render="GradientFHDBackdropX" position="100,100" size="680,1000" nexts="3" />
# for ch,
# <widget source="ServiceEvent" render="GradientFHDBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="ServiceEvent" render="GradientFHDBackdropX" position="100,100" size="185,278" nexts="2" />
# for epg, event
# <widget source="Event" render="GradientFHDBackdropX" position="100,100" size="680,1000" />
# <widget source="Event" render="GradientFHDBackdropX" position="100,100" size="680,1000" nexts="2" />
...
from .GradientFHDBackdropXDownloadThread import (
    GradientFHDBackdropXDownloadThread,
    get_store_slug,
    get_provider_override,
)

try:
    from .GradientFHDPosterXDownloadThread import get_query_variants
except Exception:
    try:
        from GradientFHDPosterXDownloadThread import get_query_variants
    except Exception:
...
try:
    from .GradientFHDConverlibr import convtext, get_canonical_slug as _xtra_convtext, apply_title_mapping as _xtra_apply_title_mapping
except Exception:
    try:
...
# GradientFHDBackdropX instances (nexts=0..4) that would otherwise fight each other.
...
# Prevent multiple GradientFHDBackdropX instances from decoding the same file
# at the same time.
# =========================================================================
...
class BackdropDB(GradientFHDBackdropXDownloadThread):
    def __init__(self):
        GradientFHDBackdropXDownloadThread.__init__(self)
        self.logdbg = None
        self.pstcanal = None
    ...
    def run(self):
        ...
        while True:
            ...
            # Provider order (live): honor overrides from GradientFHDBackdropXDownloadThread
            try:
...
class BackdropAutoDB(GradientFHDBackdropXDownloadThread):
    def __init__(self):
        GradientFHDBackdropXDownloadThread.__init__(self)
        self.logdbg = None
...
class GradientFHDBackdropX(Renderer):
        GUI_WIDGET = ePixmap
