#!/usr/bin/python3
# -*- coding: utf-8 -*-
# GradientFHDPosterX.py - patched build (progress + live bouquets + stream filter)
...
#Infobar
    #Poster now
    #<widget source="session.Event_Now" render="GradientFHDPosterX" nexts="0" position="10,285" cornerRadius="6" size="170,255" zPosition="100" scale="stretch"/>
    #Poster next
    #<widget source="session.CurrentService" render="GradientFHDPosterX" nexts="1" position="1100,285" cornerRadius="6" size="170,255" zPosition="100" scale="stretch"/>
    #Backdrop now
    #<widget source="session.CurrentService" render="GradientFHDBackdropX" nexts="1" position="800,375" cornerRadius="6" size="290,164" zPosition="98" scale="stretch"/>
    #Backdrop next
    #<widget source="session.Event_Now" render="GradientFHDBackdropX" nexts="0" position="190,375" cornerRadius="6" size="290,164" zPosition="98" scale="stretch"/>

#Channel Selection Poster
    #<widget source="ServiceEvent" render="GradientFHDPosterX" nexts="0" position="750,385" delayPic="0" usedImage="poster" cornerRadius="6" size="170,255" zPosition="100" />
    #<widget source="ServiceEvent" render="GradientFHDPosterX" nexts="1" ...
    #<widget source="ServiceEvent" render="GradientFHDPosterX" nexts="2" ...
#Channel Selection Backdrop
    #<widget source="ServiceEvent" render="GradientFHDBackdropX" nexts="0" position="750,500" delayPic="0" usedImage="backdrop" cornerRadius="6" size="170,96" zPosition="98" />
    #<widget source="ServiceEvent" render="GradientFHDBackdropX" nexts="1" ...
    #<widget source="ServiceEvent" render="GradientFHDBackdropX" nexts="2" ...
...
#EPG
    #<widget source="Event" render="GradientFHDPosterX" position="310,415" cornerRadius="6" size="170,255" zPosition="100" />
    #<widget source="Event" render="GradientFHDBackdropX" position="310,500" cornerRadius="6" size="170,96" zPosition="98" />

#Movie,EMC Selection
    #<widget source="Service" render="GradientFHDPosterX" position="825,506" cornerRadius="6" size="110,164" zPosition="100" />
    #<widget source="Service" render="GradientFHDBackdropX" position="974,506" cornerRadius="6" size="290,164" zPosition="98" />

#Player
    #<widget source="session.Event_Now" render="GradientFHDPosterX" position="10,325" cornerRadius="6" size="170,255" zPosition="100" />
    #<widget source="session.Event_Now" render="GradientFHDBackdropX" position="210,415" cornerRadius="6" size="290,164" zPosition="98" />
...
from Components.Renderer.GradientFHDPosterXDownloadThread import GradientFHDPosterXDownloadThread, get_store_slug, get_provider_override, is_daily_series, get_query_variants, try_upgrade_poster_from_info, _allow_google
...
#   (GradientFHDConverlibr.convtext + apply_title_mapping).
...
try:
    from .GradientFHDConverlibr import convtext as _xtra_convtext, apply_title_mapping as _xtra_apply_title_mapping
except Exception:
    try:
        from GradientFHDConverlibr import convtext as _xtra_convtext, apply_title_mapping as _xtra_apply_title_mapping
    except Exception:
...
class PosterDB(GradientFHDPosterXDownloadThread):
    def __init__(self):
        GradientFHDPosterXDownloadThread.__init__(self)
        # Logging aktivieren
        self.logdbg = True
    ...
    def run(self):
        ...
        while True:
            ...
            # Provider order (live queue): honor overrides from GradientFHDPosterXDownloadThread
            try:
...
class PosterAutoDB(GradientFHDPosterXDownloadThread):
        def __init__(self):
                GradientFHDPosterXDownloadThread.__init__(self)
                self.logdbg = None
...
class GradientFHDPosterX(Renderer):
        GUI_WIDGET = ePixmap
