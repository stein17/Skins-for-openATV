#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# GradientFHD_event_info.py
# Klasse GradientFHD_event_info: TMDb lookup + JSON Info speichern (merge, atomic)
...
#  <convert type="GradientFHD_event_info">poster_path</convert>
#</widget>
...
class GradientFHD_event_info(object):
    ...
    def _find_tmdb_key(self):
        ...
        candidates = [
            "/usr/lib/enigma2/python/Components/Renderer/GradientFHDStarX.py",
            "/usr/lib/enigma2/python/Components/Renderer/GradientFHDPosterXDownloadThread.py",
            "/usr/lib/enigma2/python/Components/Renderer/GradientFHDBackdropXDownloadThread.py",
        ]
        for c in candidates:
            try:
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        print("Usage: GradientFHD_event_info.py \"Title\" [slug]")
        sys.exit(1)
    title = sys.argv[1]
    slug = sys.argv[2] if len(sys.argv) > 2 else None
    g = GradientFHD_event_info()
