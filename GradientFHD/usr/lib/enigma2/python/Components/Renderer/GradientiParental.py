...
# <widget render="GradientiParental" source="session.Event_Now" position="315,874" size="50,50" zPosition="3" transparent="1" alphatest="blend"/>
...
class GradientiParental(Renderer):
