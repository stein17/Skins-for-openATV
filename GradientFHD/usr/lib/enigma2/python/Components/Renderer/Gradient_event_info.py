...
#  <convert type="Gradient_event_info">poster_path</convert>
#</widget>
...
class Gradient_event_info(object):
    ...
    def _find_tmdb_key(self):
        ...
        candidates = [
            "/usr/lib/enigma2/python/Components/Renderer/GradientStarX.py",
            "/usr/lib/enigma2/python/Components/Renderer/GradientPosterXDownloadThread.py",
            "/usr/lib/enigma2/python/Components/Renderer/GradientBackdropXDownloadThread.py",
        ]
        for c in candidates:
            try:
...
if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        print("Usage: Gradient_event_info.py \"Title\" [slug]")
        sys.exit(1)
    title = sys.argv[1]
