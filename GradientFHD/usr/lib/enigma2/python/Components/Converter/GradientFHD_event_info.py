"""
3. OPTIMIERTE GradientFHD_event_info.py
=====================================
...
try:
    from Components.Renderer.GradientFHDConverlibr import convtext, apply_title_mapping
except:
    try:
...
class GradientFHD_event_info(Converter, object):
    TITLE = 0
    ORIGINAL_TITLE = 1
    YEAR = 2
    OVERVIEW = 3
...
if __name__ == '__main__':
    print('=' * 60)
    print('GradientFHD_event_info - OPTIMIERTE VERSION')
    print('=' * 60)
    print()
    print('FEATURES:')
