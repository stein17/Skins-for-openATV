...
novpnfile = '/usr/share/enigma2/AX_Blue_FHD_4ATV/skinparts/novpn.txt'
isvpnfile = '/usr/share/enigma2/AX_Blue_FHD_4ATV/skinparts/isvpn.txt'
...
class AXBlueSambaVpnIp_converter(Poll, Converter, object):
