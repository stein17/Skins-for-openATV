# Animierter OAWeather-Renderer fuer den BundesligaWQHD Skin.
...
try:
	from Plugins.Extensions.BundesligaWQHD.settings import (
		weather_animation_config,
		weather_animation_interval_config,
		weather_iconset_config,
	)
	from Plugins.Extensions.BundesligaWQHD.weathericons import (
		DEFAULT_ICONSET_ID,
...
DEFAULT_ANIMATION_PATH = "/usr/share/enigma2/BundesligaWQHD/weather/Meteocons_Animated"
...
class BLWQHDAnimatedWeatherPixmap(Renderer):
	GUI_WIDGET = ePixmap
	weatherMaps = {}
...
if _CentralAnimatedWeatherPixmap is not None:
	BLWQHDAnimatedWeatherPixmap = _CentralAnimatedWeatherPixmap
