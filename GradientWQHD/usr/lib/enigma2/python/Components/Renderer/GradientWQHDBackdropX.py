#!/usr/bin/python3
# -*- coding: utf-8 -*-
# GradientWQHDBackdropX.py - patched build (progress + live bouquets + stream filter)
...
# <widget source="session.Event_Now" render="GradientWQHDBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Next" render="GradientWQHDBackdropX" position="100,100" size="680,1000" />
# <widget source="session.Event_Now" render="GradientWQHDBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="session.CurrentService" render="GradientWQHDBackdropX" position="100,100" size="680,1000" nexts="3" />
# for ch,
# <widget source="ServiceEvent" render="GradientWQHDBackdropX" position="100,100" size="680,1000" nexts="2" />
# <widget source="ServiceEvent" render="GradientWQHDBackdropX" position="100,100" size="185,278" nexts="2" />
# for epg, event
# <widget source="Event" render="GradientWQHDBackdropX" position="100,100" size="680,1000" />
# <widget source="Event" render="GradientWQHDBackdropX" position="100,100" size="680,1000" nexts="2" />
...
from .GradientWQHDBackdropXDownloadThread import (
    GradientWQHDBackdropXDownloadThread,
    get_store_slug,
    get_provider_override,
)

try:
    from .GradientWQHDPosterXDownloadThread import get_query_variants
except Exception:
    try:
        from GradientWQHDPosterXDownloadThread import get_query_variants
    except Exception:
...
try:
    from .GradientWQHDConverlibr import convtext, get_canonical_slug as _xtra_convtext, apply_title_mapping as _xtra_apply_title_mapping
except Exception:
    try:
...
# GradientWQHDBackdropX instances (nexts=0..4) that would otherwise fight each other.
...
# Prevent multiple GradientWQHDBackdropX instances from decoding the same file
# at the same time.
# =========================================================================
...
class BackdropDB(GradientWQHDBackdropXDownloadThread):
    def __init__(self):
        GradientWQHDBackdropXDownloadThread.__init__(self)
        self.logdbg = None
        self.pstcanal = None
    ...
    def run(self):
        ...
        while True:
            ...
            # Provider order (live): honor overrides from GradientWQHDBackdropXDownloadThread
            try:
...
class BackdropAutoDB(GradientWQHDBackdropXDownloadThread):
    def __init__(self):
        GradientWQHDBackdropXDownloadThread.__init__(self)
        self.logdbg = None
...
class GradientWQHDBackdropX(Renderer):
        GUI_WIDGET = ePixmap
