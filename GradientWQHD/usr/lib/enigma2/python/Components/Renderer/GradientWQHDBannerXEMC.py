...
#   <widget source="Service" render="GradientWQHDBannerXEMC" position="30,520" size="685,120" zPosition="3" alphatest="blend" />
#   <widget source="session.CurrentService" render="GradientWQHDBannerXEMC" position="100,780" size="800,140" zPosition="4" alphatest="blend" />
#
...
def _debug(msg):
	if DEBUG:
		try:
			print("[GradientWQHDBannerXEMC]", msg)
		except Exception:
			pass
...
class GradientWQHDBannerXEMC(Renderer):
	GUI_WIDGET = ePixmap
