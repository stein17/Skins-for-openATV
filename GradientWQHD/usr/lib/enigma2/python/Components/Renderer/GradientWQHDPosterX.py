#!/usr/bin/python3
# -*- coding: utf-8 -*-
# GradientWQHDPosterX.py - patched build (progress + live bouquets + stream filter)
...
#Infobar
    #Poster now
    #<widget source="session.Event_Now" render="GradientWQHDPosterX" nexts="0" position="10,285" cornerRadius="6" size="170,255" zPosition="100" scale="stretch"/>
    #Poster next
    #<widget source="session.CurrentService" render="GradientWQHDPosterX" nexts="1" position="1100,285" cornerRadius="6" size="170,255" zPosition="100" scale="stretch"/>
    #Backdrop now
    #<widget source="session.CurrentService" render="GradientWQHDBackdropX" nexts="1" position="800,375" cornerRadius="6" size="290,164" zPosition="98" scale="stretch"/>
    #Backdrop next
    #<widget source="session.Event_Now" render="GradientWQHDBackdropX" nexts="0" position="190,375" cornerRadius="6" size="290,164" zPosition="98" scale="stretch"/>

#Channel Selection Poster
    #<widget source="ServiceEvent" render="GradientWQHDPosterX" nexts="0" position="750,385" delayPic="0" usedImage="poster" cornerRadius="6" size="170,255" zPosition="100" />
    #<widget source="ServiceEvent" render="GradientWQHDPosterX" nexts="1" ...
    #<widget source="ServiceEvent" render="GradientWQHDPosterX" nexts="2" ...
#Channel Selection Backdrop
    #<widget source="ServiceEvent" render="GradientWQHDBackdropX" nexts="0" position="750,500" delayPic="0" usedImage="backdrop" cornerRadius="6" size="170,96" zPosition="98" />
    #<widget source="ServiceEvent" render="GradientWQHDBackdropX" nexts="1" ...
    #<widget source="ServiceEvent" render="GradientWQHDBackdropX" nexts="2" ...
...
#EPG
    #<widget source="Event" render="GradientWQHDPosterX" position="310,415" cornerRadius="6" size="170,255" zPosition="100" />
    #<widget source="Event" render="GradientWQHDBackdropX" position="310,500" cornerRadius="6" size="170,96" zPosition="98" />

#Movie,EMC Selection
    #<widget source="Service" render="GradientWQHDPosterX" position="825,506" cornerRadius="6" size="110,164" zPosition="100" />
    #<widget source="Service" render="GradientWQHDBackdropX" position="974,506" cornerRadius="6" size="290,164" zPosition="98" />

#Player
    #<widget source="session.Event_Now" render="GradientWQHDPosterX" position="10,325" cornerRadius="6" size="170,255" zPosition="100" />
    #<widget source="session.Event_Now" render="GradientWQHDBackdropX" position="210,415" cornerRadius="6" size="290,164" zPosition="98" />
...
from Components.Renderer.GradientWQHDPosterXDownloadThread import GradientWQHDPosterXDownloadThread, get_store_slug, get_provider_override, is_daily_series, get_query_variants, try_upgrade_poster_from_info, _allow_google
...
#   (GradientWQHDConverlibr.convtext + apply_title_mapping).
...
try:
    from .GradientWQHDConverlibr import convtext as _xtra_convtext, apply_title_mapping as _xtra_apply_title_mapping
except Exception:
    try:
        from GradientWQHDConverlibr import convtext as _xtra_convtext, apply_title_mapping as _xtra_apply_title_mapping
    except Exception:
...
class PosterDB(GradientWQHDPosterXDownloadThread):
    def __init__(self):
        GradientWQHDPosterXDownloadThread.__init__(self)
        # Logging aktivieren
        self.logdbg = True
    ...
    def run(self):
        ...
        while True:
            ...
            # Provider order (live queue): honor overrides from GradientWQHDPosterXDownloadThread
            try:
...
class PosterAutoDB(GradientWQHDPosterXDownloadThread):
        def __init__(self):
                GradientWQHDPosterXDownloadThread.__init__(self)
                self.logdbg = None
...
class GradientWQHDPosterX(Renderer):
        GUI_WIDGET = ePixmap
