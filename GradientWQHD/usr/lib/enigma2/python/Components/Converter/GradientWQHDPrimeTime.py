...
class GradientWQHDPrimeTime(Converter, object):
    """GradientWQHDPrimeTime

    Skin examples:
        <convert type="GradientWQHDPrimeTime">PrimeTime,noDuration</convert>
        <convert type="GradientWQHDPrimeTime">Event2,withDuration</convert>
