...
# This file is meant to be imported from the GradientWQHD Configtool.
...
SW_ON = '/usr/share/enigma2/GradientWQHD/icons/menu_on.png'
SW_OFF = '/usr/share/enigma2/GradientWQHD/icons/menu_off.png'
...
class AutoDBStatusOSD(Screen):
    skin = """
        <screen name="AutoDBStatusOSD" position="13,13" size="1307,53" backgroundColor="#80000000" cornerRadius="21" flags="wfNoBorder,wfModal" zPosition="101">
            <widget name="text" position="center,0" size="1307,53" font="Regular;36" valign="center" halign="center" cornerRadius="21" transparent="1" foregroundColor="#ffffff" borderWidth="1" borderColor="black" />
        </screen>
    """
...
class AutoDBInfoScreen(Screen):
    skin = """
    <screen name="AutoDBInfoScreen" position="center,center" size="1467,907" title="Information" flags="wfNoBorder" backgroundColor="transparent">
        ...
        <eLabel name="menu_bg" position="0,80" size="1467,827" backgroundColor="gradient_BGO,gradient_BGM,gradient_BGU,vertical" zPosition="-8" />
        <eLabel name="title_bg" position="0,0" size="1467,93" backgroundColor="gradient_TBGL,gradient_BGO,gradient_BGU,horizontal" zPosition="-9" cornerRadius="16" />
        <eLabel name="title_line" position="0,80" size="1467,5" backgroundColor="gradient_background,gradient_BGLR,gradient_BGLM,horizontal" zPosition="10" />
        <eLabel name="Line_Menu" position="20,833" size="1427,3" backgroundColor="gradient_BGLR,gradient_BGLM,gradient_BGLR,horizontal" zPosition="10" />
        <eLabel name="Line_Menu" position="20,500" size="1427,3" backgroundColor="gradient_BGLR,gradient_BGLM,gradient_BGLR,horizontal" zPosition="10" />
        <widget name="text" position="27,93" size="1413,720" font="Regular;40" backgroundColor="gradient_background" halign="left" valign="top" transparent="1" />
    </screen>
    """
...
class AutoDBManager(Screen):
    skin = """
    <screen name="AutoDBManager" position="center,center" size="1467,907" title="AutoDB Manager (Poster + Backdrop)" flags="wfNoBorder" backgroundColor="transparent">
        <widget source="Title" render="Label" position="27,0" size="1413,80" font="Italic; 56" halign="left" valign="center" transparent="1" foregroundColor="gradient_foreground_selection" backgroundColor="background" textBorderColor="black" textBorderWidth="1" zPosition="1" />
        <eLabel name="menu_bg" position="0,80" size="1467,827" backgroundColor="gradient_BGO,gradient_BGM,gradient_BGU,vertical" zPosition="-8" />
        <eLabel name="title_bg" position="0,0" size="1467,93" backgroundColor="gradient_TBGL,gradient_BGO,gradient_BGU,horizontal" zPosition="-9" cornerRadius="16" />
        <eLabel name="title_line" position="0,80" size="1467,5" backgroundColor="gradient_background,gradient_BGLR,gradient_BGLM,horizontal" zPosition="10" />
        <eLabel name="Line_Menu" position="20,833" size="1427,3" backgroundColor="gradient_BGLR,gradient_BGLM,gradient_BGLR,horizontal" zPosition="10" />
        <widget name="list" position="27,93" size="1413,720" font="Regular;40" backgroundColor="gradient_background" scrollbarMode="showOnDemand" itemHeight="60" transparent="1" />
        <ePixmap pixmap="buttons/key_red.png" position="27,853" size="40,40" alphatest="blend" zPosition="10" transparent="1" />
        <ePixmap pixmap="buttons/key_green.png" position="427,853" size="40,40" alphatest="blend" zPosition="10" transparent="1" />
        <ePixmap pixmap="buttons/key_yellow.png" position="787,853" size="40,40" alphatest="blend" zPosition="10" transparent="1" />
        <ePixmap pixmap="buttons/key_blue.png" position="1147,853" size="40,40" alphatest="blend" zPosition="10" transparent="1" />
        <widget name="key_red" position="80,847" size="347,53" backgroundColor="gradient_background" font="Regular;32" valign="center" halign="left" transparent="1" />
        <widget name="key_green" position="480,847" size="293,53" backgroundColor="gradient_background" font="Regular;32" valign="center" halign="left" transparent="1" />
        <widget name="key_yellow" position="840,847" size="293,53" backgroundColor="gradient_background" font="Regular;32" valign="center" halign="left" transparent="1" />
        <widget name="key_blue" position="1200,847" size="240,53" backgroundColor="gradient_background" font="Regular;32" valign="center" halign="left" transparent="1" />
    </screen>
    """
    ...
    def __init__(self, session):
        ...
        self['list'].l.setFont(0, gFont('Regular', 40))
    ...
    def _row_option(self, key, label, enabled):
        ...
        res = [data]
        if png:
            res.append(MultiContentEntryPixmapAlphaTest(pos=(13, 9), size=(85, 35), png=png))
        else:
            res.append(MultiContentEntryText(pos=(13, 0), size=(107, 56), font=0, text='[x]' if enabled else '[ ]',
                                             flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
        res.append(MultiContentEntryText(pos=(120, 0), size=(1307, 56), font=0, text=label,
                                         flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
        return res
    ...
    def _row_sep(self, text):
        ...
        res = [data]
        res.append(MultiContentEntryText(pos=(13, 0), size=(1387, 56), font=0, text=text,
                                         flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
        return res
    ...
    def _row_bouquet(self, bouquet_id, name, enabled):
        ...
        if png:
            ...
            res.append(MultiContentEntryText(pos=(13, 0), size=(107, 56), font=0, text='[x]' if enabled else '[ ]',
                                             flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
        res.append(MultiContentEntryText(pos=(120, 0), size=(1307, 56), font=0, text=name or bouquet_id,
                                         flags=RT_HALIGN_LEFT | RT_VALIGN_CENTER))
        return res
    ...
    def _start_cb(self, ok, active_bq, total_srv):
        ...
        try:
            from Components.Renderer.GradientWQHDAPIProxy import reset_proxy_circuit
            reset_proxy_circuit()
        except Exception:
            pass
        ...
        if self.run_poster:
            try:
                from Components.Renderer import GradientWQHDPosterX  # noqa: F401
                _ui_log('poster worker import OK')
            except Exception as err:
                _ui_log('poster worker import FAILED: %s: %s' % (err.__class__.__name__, err))
        if self.run_backdrop:
            try:
                from Components.Renderer import GradientWQHDBackdropX  # noqa: F401
