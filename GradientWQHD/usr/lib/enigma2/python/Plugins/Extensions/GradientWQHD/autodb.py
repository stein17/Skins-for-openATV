...
class AutoDBStatusOSD(Screen):
    skin = """
        <screen name="AutoDBStatusOSD" position="13,13" size="2000,53" backgroundColor="#80000000" cornerRadius="21" flags="wfNoBorder,wfModal" zPosition="101">
            <widget name="text" position="center,0" size="2000,53" font="Regular;36" valign="center" halign="center" cornerRadius="21" transparent="1" foregroundColor="#ffffff" borderWidth="1" borderColor="black" />
        </screen>
    """
