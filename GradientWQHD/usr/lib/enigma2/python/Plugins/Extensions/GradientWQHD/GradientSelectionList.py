...
selectiononpng = LoadPixmap(cached=True, path="/usr/share/enigma2/GradientWQHD/icons/lock_on.png")
selectionoffpng = LoadPixmap(cached=True, path="/usr/share/enigma2/GradientWQHD/icons/lock_off.png")
